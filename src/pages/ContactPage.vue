                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="map">
                                <div class="gmap-box">
                                    <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31511.88811787338!2d7.299805976532752!3d9.1557336375887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104dd8f1cae4b611%3A0x6e69ae7a4719bb62!2sKubwa%2C%20Abuja%20901101%2C%20Federal%20Capital%20Territory!5e0!3m2!1sen!2sng!4v1722549723616!5m2!1sen!2sng"></iframe>
                                </div>
                            </div>
                            <!-- End Map Area -->
                        </div>
                            ...
                            <div class="contact-sidebar-wapper">
                                <div class="contact-sidebar">
                                    ...
                                    <ul class="contact-sidebar-list-item">
                                        ...
                                        <li class="contact-sidebar-single-box">
                                            ...
                                            <a href="tel:+2348061982520" class="link">+2348061982520</a>
                                        </li>
                                        <!-- End contact Single Box -->
                                        <!-- Start contact Single Box -->
                                        <li class="contact-sidebar-single-box">
                                            <h6 class="title-text">Email:</h6>
                                            <a href="mailto:devs@ebustech.com" class="link">devs@ebustech.com</a>
                                        </li>
                                        <!-- End contact Single Box -->
                                        <!-- Start contact Single Box -->
                                        <li class="contact-sidebar-single-box">
                                            <h6 class="title-text">Website:</h6>
                                            <a href="https://www.ebustech.com/" class="link">www.ebustech.com</a>
                                        </li>
                                        <!-- End contact Single Box -->
                                        <!-- Start contact Single Box -->
                                        <li class="contact-sidebar-single-box">
                                            <h6 class="title-text">Address:</h6>
                                            <span class="text"> kubwa, FCT Abuja</span>
                                        </li>
                                        <!-- End contact Single Box -->
                                    </ul>
                                ...
                                <div class="sidebar-widget-single-area ">
                                    ...
                                    <ul class="social-link">
                                        <li><a href="https://facebook.com/ebubeireneaus" target="_blank"><i class="icofont-facebook"></i></a></li>
                                        <li><a href="https://instagram.com/ebubeireneaus" target="_blank"><i class="icofont-instagram"></i></a></li>
                                        <li><a href="https://twitter.com/ebubeireneaus" target="_blank"><i class="icofont-linkedin"></i></a></li>
                                    </ul>
                                </div>
...
const metaData = {
  title: 'Reach Out - Ebustech Web & Mobile App Service',
  meta: {
    description: { name: 'description', content: 'Have a project in mind or need expert advice? Contact Ebustech today! Reach out to me through a contact form, email, or phone number. Let\'s discuss your digital future!' },
    keywords: {
      name: 'keywords',
      content:
    ...
    ogTitle: {
      property: 'Reach Out - Ebustech Web & Mobile App Developer Service',
    },
  },
};
